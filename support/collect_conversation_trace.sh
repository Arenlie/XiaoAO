...
if [[ $# -lt 1 || -z "${1:-}" ]]; then
  echo "用法: sudo /home/chaos/program/collect_conversation_trace.sh <conversation-id>" >&2
  echo "示例: sudo /home/chaos/program/collect_conversation_trace.sh xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" >&2
  exit 2
fi
...
export PHM_COLLECT_MODE="conversation"
