...
async function sendMessage(prefilled=null){
  ...
  try{
    ...
    if(previousChoice){state.settledDiagnosisIds.add(previousChoice.confirmation_id);const previousMessage=messageById(previousChoice.message_id);if(previousMessage)previousMessage.status="STOPPED";}
